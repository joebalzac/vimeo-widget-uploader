...
import MultiStepForm from "./MultiStepFormHealth";
import { props } from "@webflow/data-types";
import { declareComponent } from "@webflow/react";

export default declareComponent(MultiStepForm, {
  name: "Multi-Step Form (Health)",
  description:
    "A multi-step form that collects health care provider details step by step and submits them as a single HubSpot form submission. Supports an optional split layout with a content panel.",
  group: "Forms",
  ...
  props: {
    ...
    formGuid: props.Text({
      ...
      defaultValue: "46995898-7b5b-405d-a9b9-0d9673bf0c89",
