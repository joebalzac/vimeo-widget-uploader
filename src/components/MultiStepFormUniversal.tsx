            ...
            <div className="hsf__fields">
              ...
              >
                <input
                  ...
                  aria-describedby={errors.email ? "msfu-email-error" : undefined}
                  aria-required="true"
                  autoComplete="email"
                />
                <button
              ...
              {errors.email && (
                <span id="msfu-email-error" className="fieldError">
                  {errors.email}
                </span>
              )}
            </div>
                ...
                {phase === "picker" && (
                  <div className="hsf__overlay-inner">
                    <div
                      ...
                      aria-valuemin={0}
                      aria-valuemax={100}
                      aria-valuetext="Industry selection"
                    >
                      <div
                              ...
                              <div className="hsf__row">
                                <div className="hsf__col">
                                  ...
                                  <input
                                    ...
                                    aria-describedby={
                                      errors.firstname
                                        ? "msfu-firstname-error"
                                        : undefined
                                    }
                                  />
                                  {errors.firstname && (
                                    <span
                                      id="msfu-firstname-error"
                                ...
                                <>
                                  ...
                                  <div className="hsf__col">
                                    ...
                                    <input
                                      ...
                                      aria-describedby={
                                        errors.num_providers
                                          ? "msfu-providers-error"
                                          : undefined
                                      }
                                    />
                                    {errors.num_providers && (
                                      <span
                                        id="msfu-providers-error"
                                        className="fieldError"
                                      >
                                        {errors.num_providers}
                                      </span>
