...
export default function MultiStepForm({
  ...
  return (
    <>
          ...
          <div className="hsf__step-1-container">
            ...
            <div className="hsf__lowbrow-container">
              ...
              <svg
                ...
                fill="none"
              >
                <g clip-path="url(#clip0_14489_288)">
                  <mask
                    id="mask0_14489_288"
              ...
              <svg
                ...
                fill="none"
              >
                <g clip-path="url(#clip0_14442_1460)">
                  <path
      ...
      {disableOverlay && step > 1 && <FormInner {...innerProps} />}
    </>
  );
}
