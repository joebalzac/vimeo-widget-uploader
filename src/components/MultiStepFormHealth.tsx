      ...
      <div className="msf__content-inner">
        ...
        {contentOnlyLogoUrl && (
          <img
            ...
            alt={contentLogoAlt}
            className="msf__content-logo-health"
          />
        )}
              ...
              <div className="hsf__form-col" onKeyDown={onKeyDown}>
                {submitted ? (
                  <div className="hsf__success">
                    <svg viewBox="0 0 200 200" width="100" height="100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                      <title>Success</title>
                          ...
                          <div className="hsf__fields">
                            ...
                            <div className="hsf__col">
                              ...
                              <select
                                ...
                                aria-required="true"
                                aria-invalid={Boolean(errors.ehr)}
                                aria-describedby={
                                  errors.ehr ? "hsf-ehr-error" : undefined
                                }
                              >
                              ...
                              {errors.ehr && (
                                <span id="hsf-ehr-error" className="fieldError">
                                  {errors.ehr}
                                </span>
                              )}
                            </div>
                            ...
                            <div className="hsf__col">
                              <label className="field-label" htmlFor="hsf-how_did_you_hear_about_us">
                                How Did You Hear About Us?
                              </label>
                              <textarea
                                  id="hsf-how_did_you_hear_about_us"
                                ...
                                aria-describedby={
                                  errors.how_did_you_hear_about_us
                                    ? "hsf-how_did_you_hear_about_us-error"
                                    : undefined
                                }
                              />
                              {errors.how_did_you_hear_about_us && (
                                <span
                                  id="hsf-how_did_you_hear_about_us-error"
                                  className="fieldError"
                                >
                                  {
                                    errors.how_did_you_hear_about_us
